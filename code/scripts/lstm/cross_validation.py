...
from scripts.lstm.dataset import cross_val_loaders
from scripts.lstm.training import train, test, seed_torch, data_config, SEQ_LEN, N_CLASSES
...
if __name__ == '__main__':
    ...
    for k, (train_loader, test_loader) in enumerate(kfold_loaders):
        ...
        torch.save(model.state_dict(), f'data/models/cross_val/lstm/model_k{k}.pth')
